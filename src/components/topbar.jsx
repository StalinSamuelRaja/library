...
export default function Topbar() {
  return (
    <div className="navbar bg-base-100 bg-success-content">
      <div className="flex-1">
        ...
        <Link to="/" className="btn bg-secondary-content  normal-case text-xl flex items-center">
          Library dashboard
        </Link>
      </div>
      <div className="flex-none">
        <ul className="menu menu-horizontal text-xl  px-1">
          <li className="btn bg-secondary-content">
